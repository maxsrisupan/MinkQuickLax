...
public sealed class GlassMenuWindow : GlassSurfaceWindow
{
    public GlassMenuWindow(ThemeService theme, string? header, IReadOnlyList<MenuEntry> entries)
        : base(theme, "Glass.Fill.Menu")
    {
        ...
        if (!string.IsNullOrEmpty(header))
        {
            ...
            title.SetResourceReference(TextBlock.ForegroundProperty, "Glass.Ink2");
        ...
        foreach (var entry in entries)
        {
            switch (entry)
            {
                ...
                case MenuCommand command:
                    ...
                    {
                        Style = (Style)FindResource("Glass.MenuRow"),
    ...
    private static Border Separator()
    {
        ...
        line.SetResourceReference(Border.BackgroundProperty, "Glass.Edge");
        return line;
    }
}
...
public sealed class NoticeWindow : GlassSurfaceWindow
{
        ...
        : base(theme, "Glass.Fill.Notice")
    {
        ...
        {
            var styleKey = b.IsPrimary ? "Glass.AccentButton" : b.IsDanger ? "Glass.DangerButton" : "Glass.Button";
