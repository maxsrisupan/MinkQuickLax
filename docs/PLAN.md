...
> **ความคืบหน้า:** M0–M10 เสร็จ · **M11** ทำโค้ด สคริปต์ และ workflow ออกรุ่นเสร็จแล้ว รอผู้ใช้ยืนยันก่อนออก `v0.1.0-beta.1` (หน้า Release เป็นสาธารณะ) และทดสอบติดตั้งตามหัวข้อ 8.2 (หัวข้อ 6)
...
- **ยังต้องทำ/ตรวจ (ต้องให้ผู้ใช้ยืนยันก่อน):** ออก `v0.1.0-beta.1` ด้วยการ push tag (หน้า Release เป็นสาธารณะ) · ติดตั้งจริงบนเครื่อง (เครื่องนี้ไม่มี Windows Sandbox และการติดตั้งจะลงทะเบียนเปิดพร้อม Windows ของผู้ใช้) · อัปเดตจาก GitHub Release จริง · รายการในหัวข้อ 8.2
