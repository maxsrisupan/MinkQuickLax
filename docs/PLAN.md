...
> **ความคืบหน้า:** M0–M10 เสร็จ · **M11** ออก [`v0.1.0`](https://github.com/maxsrisupan/MinkQuickLax/releases/tag/v0.1.0) แล้ว (2026-09-15) · ถัดไป: ผู้ใช้ตรวจรายการในหัวข้อ 8.2 ที่ยังไม่ติ๊ก (ต้องใช้มือหรือฮาร์ดแวร์จริง) แล้วแก้สิ่งที่เจอเป็น 0.1.x (`v0.1.1` 2026-09-16: Glass ใหม่ กระจกฝ้า และหน้าต่างเพิ่มเว็บ ดู M11 "แก้หลังออก 0.1.0" · `v0.1.2` 2026-09-16: icon ของ app ใหม่ ดู M11 "แก้หลังออก 0.1.1") · จากนั้นเริ่มเฟส 2 (หัวข้อ 7)
...
- [x] tray: คลิกซ้ายซ่อน/แสดง, เมนูคลิกขวา (SPEC 4.7), icon ของ app (.ico 16–256px เดิมทำจากลูกแก้วสี `#2FD9BE/#FFC15A/#FF7250` ใน mockup · เปลี่ยนเป็นวงโคจรใน 0.1.2 ดู M11) · สร้างซ้ำได้ด้วย `build/make-app-icon.ps1`
...
- **แก้หลังออก 0.1.0 (ออกใน 0.1.1):**
  - [x] **Glass สวยขึ้นและกระจกฝ้า (2026-09-16):**
    - **ที่มา:** ผู้ใช้อยากให้ Glass สวยขึ้นตามภาพอ้างอิง glassmorphism · ตรวจแล้วเครื่องผู้ใช้ปิด Transparency effects จึงเห็นเป็นพื้นทึบ 92%
    - **ทำแล้ว:** แสงบนกระจก (SPEC 5.2) · กระจกฝ้าจากภาพพื้นหลังเมื่อ Windows ไม่เบลอ (SPEC 5.5) · ข้อความใต้ "เบลอข้างหลัง" ในหน้าตั้งค่าและคู่มือบอกเรื่องนี้
    - **ตรวจแล้ว:** render หน้าต่างจริงของ app บนจอด้วยเครื่องมือชั่วคราว เทียบก่อน/หลัง ธีมมืดและสว่าง · HUD และ Dot Matrix ต่างแค่ไอคอนตัวอักษร · กระจกฝ้ากับภาพพื้นหลังตัวอย่าง (ภาพพื้นหลังของผู้ใช้เป็นสีดำล้วน)
    - **ยังต้องตรวจ:** acrylic จริงตอนเปิด Transparency effects จากหน้า Settings ของ Windows (ตั้งผ่าน registry แล้ว DWM ไม่รับ จึงคืนค่าเดิม) · กระจกฝ้าบนหน้าตั้งค่าตอนลากหน้าต่าง
